...
Xtra_Blue <- colorRampPalette(Xtra_Blue)(12)
...
This work is a reimagining of my other Kaggle projects [HERE](https://www.kaggle.com/mcnamamj/us-county-spread-sir-mice-svm) and [HERE](https://www.kaggle.com/mcnamamj/covid-19-graphing-and-mapping) reassembled in a dashboard style for easier digestion. If you like my work, please upvote it! Let me know if there are any questions or comments below!

Thank you to [Saba Tavoosi](https://www.kaggle.com/tavoosi/suicide-data-full-interactive-dashboard) for inspiration from her wonderful Suicide interactive dashboard. In particular, the slick pie charts rendered in highchart. In addition [Philipp Spachtholz](https://www.kaggle.com/philippsp/interactive-dashboards-in-r) for his dashboard on the titanic disaster. Not to mention the Times for providing the dataset.
